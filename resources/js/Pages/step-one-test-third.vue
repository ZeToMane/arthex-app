    ...
    <div class="main-container">
                    ...
                    <div class="button-wrapper canvas-container">
                        <div class="button-content justify-center">
                            <div class="btn-type-1 btn-type-1-alt p-4-8" @click="setThirdChoise">
                                <p class="btn-content">désolation</p>
                            </div>
                            <div class="btn-type-1 btn-type-1-alt p-4-8" @click="setThirdChoise">
                                <p class="btn-content">préoccupation</p>
                            </div>
                            <div class="btn-type-1 btn-type-1-alt p-4-8" @click="setThirdChoise">
                                <p class="btn-content">mépris</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="button-wrapper">
            <div class="button-content btn-big-continue">
                <Link id="validation"  href="step-two-intro" class="btn-type-1 display-none bg-green">
